...
export const metadata: Metadata = {
  title: 'Cancellation & Refund Policy — Digital Study Resources',
  description:
    'Cancellation and refund rules for Studious Harshita digital study resources, including refund eligibility, processing timelines and how to raise a request.',
  alternates: { canonical: '/refund-policy' },
  openGraph: {
    type: 'website',
    url: '/refund-policy',
    title: 'Cancellation & Refund Policy | Studious Harshita',
    description: 'Refund eligibility, timelines and how to raise a request for digital study resources.',
  },
};
    ...
    <div className="min-h-screen flex flex-col bg-[var(--background)]">
      ...
      <main className="flex-1 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-[#1A1A1A] mb-8">Cancellation & Refund Policy</h1>
            
            <div className="space-y-6 text-[#4A443B]">
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">1. Cancellation Policy</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">2. Digital Products Nature</h2>
                <p className="leading-relaxed text-justify">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">3. Refund Eligibility</h2>
                <p className="leading-relaxed text-justify">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">4. Refund Request Process</h2>
                <p className="leading-relaxed text-justify">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">5. Non-Refundable Cases</h2>
                <p className="leading-relaxed text-justify">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">6. Refund Method & Timeline</h2>
                <p className="leading-relaxed text-justify">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">7. Partial Refunds</h2>
                <p className="leading-relaxed text-justify">
