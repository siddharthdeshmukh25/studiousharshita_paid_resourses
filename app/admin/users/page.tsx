    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl sm:text-3xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">Users</h1>
      ...
      <section className="overflow-hidden rounded-xl border border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
        <div className="border-b border-gray-200 px-4 py-3 dark:border-gray-700 sm:px-5 sm:py-4">
          ...
          <p className="mt-0.5 text-xs text-gray-600 dark:text-gray-400 sm:text-sm">Click any user to see their complete activity.</p>
        </div>
          ...
          <table className="min-w-[820px] w-full text-left text-sm">
            <thead className="bg-gray-50 text-xs uppercase tracking-wide text-gray-600 dark:bg-gray-800 dark:text-gray-400">
              <tr>
                ...
                <th className="px-3 py-2.5 sm:px-5 sm:py-3">Country</th>
                <th className="px-3 py-2.5 sm:px-5 sm:py-3">Joined</th>
                <th className="px-3 py-2.5 sm:px-5 sm:py-3">Website visits</th>
                <th className="px-3 py-2.5 sm:px-5 sm:py-3">Resource opens</th>
                <th className="px-3 py-2.5 sm:px-5 sm:py-3">Last seen</th>
                <th className="px-3 py-2.5 sm:px-5 sm:py-3"></th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {loading ? (
                ...
                <tr key={user._id} className="hover:bg-gray-100 dark:hover:bg-gray-800">
                  ...
                  <td className="px-3 py-2.5 text-gray-600 dark:text-gray-400 sm:px-5 sm:py-3">{formatDate(user.createdAt)}</td>
                  <td className="px-3 py-2.5 font-medium text-gray-900 dark:text-gray-100 sm:px-5 sm:py-3">{user.visits}</td>
                  <td className="px-3 py-2.5 font-medium text-gray-900 dark:text-gray-100 sm:px-5 sm:py-3">{user.resourceOpens}</td>
                  <td className="px-3 py-2.5 text-gray-600 dark:text-gray-400 sm:px-5 sm:py-3">{formatDate(user.lastVisit)}</td>
