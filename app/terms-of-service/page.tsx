...
export const metadata: Metadata = {
  title: 'Terms of Service — Purchasing Digital Study Notes',
  description:
    'The terms that govern accounts, payments, instant digital delivery, licensing and acceptable use of study resources purchased from Studious Harshita.',
  alternates: { canonical: '/terms-of-service' },
  openGraph: {
    type: 'website',
    url: '/terms-of-service',
    title: 'Terms of Service | Studious Harshita',
    description: 'Terms covering accounts, payments and use of our digital study resources.',
  },
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-[#1A1A1A] mb-8">Terms of Service</h1>
            ...
            <div className="space-y-6 text-[#4A443B]">
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">1. Introduction and Agreement</h2>
                <p className="leading-relaxed text-justify">
                  Welcome to Studious Harshita. These Terms of Service (&quot;Terms&quot;) govern your access to and use of our website, digital resources, and services. This platform is officially owned and operated by Harshita Pravinbhai Soni. By registering an account, accessing the platform, or completing a purchase, you agree to be strictly bound by these Terms. If you do not agree, please do not use our services.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">2. Account Registration and Security</h2>
                <p className="leading-relaxed text-justify">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">3. Purchases, Payments, and Delivery</h2>
                <p className="leading-relaxed text-justify">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">4. Intellectual Property and Usage License</h2>
                <p className="leading-relaxed text-justify">
                  All digital resources, study materials, notes, and content provided on Studious Harshita are the exclusive intellectual property of the platform creators.
                </p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">5. User Conduct</h2>
                <p className="leading-relaxed text-justify">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">6. Limitation of Liability</h2>
                <p className="leading-relaxed text-justify">
              ...
              <section>
                <h2 className="text-xl font-semibold text-[#1A1A1A] mb-3">7. Governing Law and Jurisdiction</h2>
                <p className="leading-relaxed text-justify">
