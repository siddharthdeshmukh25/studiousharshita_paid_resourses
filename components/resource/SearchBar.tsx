...
export default function SearchBar({ 
  ...
  return <div className="relative">
    ...
    <input 
      ...
      className="block w-full rounded-lg border border-[#CBD5E1] bg-[var(--background)] py-2 pl-9 pr-9 text-sm text-[#0F172A] placeholder:text-[#94A3B8] focus:border-[var(--sage)] focus:bg-[#FFFDF8] focus:outline-none transition-all" 
    />
