const Line = ({ className = '' }: { className?: string }) => (
  <div className={`relative overflow-hidden rounded-md bg-[var(--accent-soft-2)] ${className}`} />
);

export default function CheckoutSkeleton() {
  return (
    <div className="academic-surface min-h-screen animate-pulse">
      <header className="border-b border-[#E2E8F0] bg-[#FFFDF8]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between gap-3">
            <div className="flex items-center gap-2.5">
              <div className="h-9 w-9 rounded-lg bg-[var(--accent-soft-2)]" />
      ...
      <main className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-5">
          <div className="space-y-6 lg:col-span-3">
            <section className="rounded-2xl border border-[var(--line)] bg-[#FFFDF8] p-6">
              <Line className="mb-5 h-6 w-40" />
              <div className="flex gap-5">
                <div className="h-24 w-24 rounded-xl bg-[var(--accent-soft-2)] md:h-28 md:w-28" />
